...
To deploy the  To do list Website to a live server, follow these steps:
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/Nessrine88/Todolist/issues).
